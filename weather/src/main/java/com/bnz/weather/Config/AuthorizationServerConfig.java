...
public class AuthorizationServerConfig {
	...
	public UserDetailsService userDetailsService() {
		UserDetails userDetails = User.withUsername("mehuli").password("mehuli").authorities("USER").build();
	...
	public RegisteredClientRepository registeredClientRepository() {
		RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString()).clientId("weather-client")
